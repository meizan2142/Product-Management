...
const Card = () => {
    ...
    if (isLoading) return <div className="text-center my-96"><SyncLoader color="#36D2B4"/></div>;
        ...
        <div className="grid grid-cols-3 items-center gap-4">
            {
                data.record.map((product) => <div key={product.id} className="max-w-[350px] space-y-4 rounded-lg bg-white p-6 shadow-lg md:w-[350px] dark:bg-[#18181B]">
                    ...
                    <div className="grid gap-2">
                        <h1 className="text-lg font-semibold ">STAR WARS™ STORM TROOPER ARTISAN KEYCAP</h1>
